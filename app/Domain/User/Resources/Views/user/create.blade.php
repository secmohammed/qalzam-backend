                    ...
                    <div class="card-body">
                        <form class="form" enctype="multipart/form-data" action="{{ route('users.store') }}" method="POST">
                            ...
                            <div class="row container-fluid mb-5">
                                ...
                                <div class="col-xl-10">
                                    @include("{$alias}::user._partials._fields", [
                                    'action' => 'create',
                                    'roles' => $roles
                                    ])
                                </div>
                                ...
                                <div class="col-lg-2">
                                    <button type="submit"
                                    class="btn btn-block btn-sm btn-light-primary font-weight-bolder text-uppercase py-4">{{__('main.create')}} {{__('main.user')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
