<div class="flex space-x-1">
    <a href="{{ route('accommodations.show', [$id]) }}"
    ...
    <a href="{{ route('accommodations.edit', [$id]) }}"
    ...
    <a href="{{ route('accommodations.destroy', [$id]) }}"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('main.delete') }} {{ __('main.accommodations') }}:
                    #{{ $id }}</h5>
            ...
            <form action="{{ route('accommodations.destroy', [$id]) }}" method="post">
                ...
                <div class="modal-body">
                    {{ __('main.delete') }} {{ __('main.accommodations') }}: #{{ $id }}
                </div>
