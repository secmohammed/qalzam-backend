...
@section('content')
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <h5 class=" text-dark font-weight-bold my-1 mr-5 {{ GetLanguage() == 'ar' ? 'ml-2' : '' }}">
                        {{ __('main.show') }} {{ __('main.accommodation') }} </h5>
                    <!--end::Page Title-->
                ...
                <div class="col-md-12">
                    <div class="card card-custom">
                        <div class="card-header">
                            <h3 class="card-title">
                                {{ __('main.show') }} {{ __('main.accommodation') }} : # {{ $accommodation->id }}
                            </h3>
                            <div class="card-toolbar">
                                <a title="{{ __('main.create') }} {{ __('main.accommodation') }}"
                                   href="{{ route('accommodations.create') }}"
                                   class="btn btn-light-primary font-weight-bolder mr-2">
                                    <i class="flaticon2-plus"
                                       style="color: #FFF"></i> {{ __("main.add") }} {{ __("main.accommodation") }} </a>
                                <a title="{{ __('main.delete') }} {{ __('main.accommodation') }}"
                                   href="{{ route('accommodations.destroy', $accommodation->id) }}"
                                   class="btn btn-light-danger font-weight-bolder mr-2" data-toggle="modal"
                                   data-target="#delete_{{$accommodation->id}}">
                                    <i class="flaticon2-trash"></i> {{ __("main.delete") }} {{ __("main.accommodation") }}
                                </a>
                                <a title="{{ __('main.edit') }} {{ __('main.accommodation') }}"
                                   href="{{ route('accommodations.edit', $accommodation->id) }}"
                                   class="btn btn-light-warning font-weight-bolder mr-2">
                                    <i class="flaticon2-edit"></i> {{ __("main.edit") }} {{ __("main.accommodation") }} </a>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-5">
                                    <div class="row mb-2">
                                        ...
                                        <span>{{ $accommodation->capacity ?? 'N/A' }} </span>
                                    </div>
                                    <hr>
                                </div>
                                <div class="col-md-6 mb-5">
                                ...
                                <div class="col-md-6 mb-5">
                                    <div class="row mb-2">
                                        ...
                                        <span>{{ $accommodation->user->name ?? 'N/A' }} </span>
                                    </div>
                                    <hr>
                                </div>
                                <div class="col-md-6 mb-5">
                                    <div class="row mb-2">
                                        ...
                                        <span>{{$accommodation->branch->name}}</span>
                                    </div>
                                    <hr>
                                </div>
                                <div class="col-md-6 mb-5">
                                ...
                                <div class="col-md-6 mb-5">
                                    <div class="row mb-2">
                                        ...
                                        <span>{{$accommodation->created_at}}</span>
                                    </div>
                                    <hr>
                                </div>
    ...
    <div class="modal fade" id="delete_{{$accommodation->id}}" tabindex="-1" role="dialog"
         aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ __('main.delete') }} {{ __('main.accommodation') }}
                        : {{ __('main.accommodations') }} #({{ $accommodation->name }})</h5>
                ...
                <form action="{{ route('accommodations.destroy', $accommodation->id) }}" method="post">
                    ...
                    <div class="modal-body">
                        {{ __('main.delete') }} {{ __('main.accommodations') }}: {{ __('main.accommodations') }}
                        #({{ $accommodation->name }})
                    </div>
