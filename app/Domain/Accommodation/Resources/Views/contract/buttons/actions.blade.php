<div class="flex space-x-1">
    <a href="{{ route('contracts.show', [$id]) }}"
    ...
    <a href="{{ route('contracts.edit', [$id]) }}"
    ...
    <a href="{{ route('contracts.destroy', [$id]) }}"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('main.delete') }} {{ __('main.contracts') }}:
                    #{{ $id }}</h5>
            ...
            <form action="{{ route('contracts.destroy', [$id]) }}" method="post">
                ...
                <div class="modal-body">
                    {{ __('main.delete') }} {{ __('main.contracts') }}: #{{ $id }}
                </div>
