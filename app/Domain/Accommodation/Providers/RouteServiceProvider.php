...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'App\Domain\Accommodation\Http\Controllers';
    ...
    protected function mapWebRoutes()
    {
        Route::middleware('web')
            ...
            ->group(app_path('Domain/Accommodation/Routes/web/public.php'));

        Route::middleware('web')
            ->prefix(config('system.admin.prefix'))
            ->namespace($this->namespace)
            ->group(app_path('Domain/Accommodation/Routes/web/guest.php'));
