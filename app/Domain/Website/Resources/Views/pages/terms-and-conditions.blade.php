...
@section('content')
    <section class="terms-and-conditions">
        <div class="container">
            ...
            <h2 class="title">{{__('website.terms-and-conditions')}}</h2>
            <p>{{__('website.terms-conditions.desc-1')}}</p>
            <div class="content">
                <h3 class="title">{{__('website.terms-conditions.title-2')}}</h3>
                <p class="text">{{__('website.terms-conditions.desc-2')}}</p>
            </div>
        </div>
    </section>
@endsection
