            ...
            <div class="row">
                <div class="col-sm-5 item flex">
                    <div class="inner-text">
                        <h1 class="title">مرحبا بكم في مطاعم ومنتجعات <br/> أسماك القلزم</h1>
                        <p class="text">نحن ندعوك للاستمتاع لتجربة آطباق القلزم اللذيذة والرائعة في مطعمنا والتى يتم تحضيرها من اجود المواد كل يوم وخاصة بالنسبة لك <br/><br/> استمتع بوجبة غداء أو عشاء لذيذ في احدي فروعنا . أنشأ الطهاة الخبراء لدينا قائمة شاملة من المؤكد أنها ستشبع أي ذوق</p><a class="bottom" href="list.html">
                            قائمة الطعام
    ...
    <section class="partners">
        <div class="container">
            ...
            <div class="partners-slider">
                <div class="item">
                    <p>نشكر مركز الاتصال لمساعدتنا لعمل الطلب ومتابعة لحين استلام الطلب وإجراء استبيان بعد مرور ٢٤ ساعة <br/>شكرا للاهتمامكم</p>
                    <h4 class="name">عبدالقاسم المسعود</h4>
                    <div class="photo"><img src="images/par.svg" alt="" title=""></div>
                </div>
                <div class="item">
                    <p>نشكر مركز الاتصال لمساعدتنا لعمل الطلب ومتابعة لحين استلام الطلب وإجراء استبيان بعد مرور ٢٤ ساعة <br/>شكرا للاهتمامكم</p>
                    <h4 class="name">عبدالقاسم المسعود</h4>
