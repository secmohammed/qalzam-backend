...
<section class="employment">
    <div class="container">
        ...
        <h2 class="title">للتوظيف</h2>
        <div class="row">
            <div class="col-sm-6 item">
                <div class="inner">
                    <form action="{{route('website.employment.store')}}" method="post">
                        @csrf
            ...
            <div class="col-sm-6 item"><img src="{{asset('assets/website/images/employment.png')}}" alt="" title=""></div>
        </div>
    </div>
</section>
@endsection
