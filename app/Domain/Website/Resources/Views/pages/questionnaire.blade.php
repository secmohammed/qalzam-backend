...
@section('content')
    <section class="restaurant-questionnaire">
        <div class="container">
            <ul class="wizard">
                ...
                <li>استبيان المطعم</li>
            </ul>
            <h2 class="title">استبيان المطعم</h2>
            <div class="row">
                <div class="col-sm-6 item">
                    <div class="inner">
                        <h4 class="title">عزيزنا العميل لا تتردد في توضيح رأيك حتي يتسني لنا تطوير خدماتنا وفروعنا </h4>
                        <form action="{{route('website.questionnaire.store')}}" method="post">
                            @csrf
                            ...
                            <div class="field">
                                <label>الإسم </label>
                                <input class="form-control" type="text" placeholder="الإسم" value="">
                            </div>
                            <div class="field">
                                <label>الجول </label>
                                <input class="form-control" type="text" placeholder="الجول" value="">
                            </div>
                            <div class="field">
                                <label>التاريخ </label>
                                <input class="form-control" placeholder="التاريخ" id="date" name="date" value=""><img src="{{asset('assets/website/images/calendar.svg')}}" alt="" title="">
                            </div>
                            <div class="field">
                ...
                <div class="col-sm-6 item"><img src="{{asset("assets/website/images/questionnaire.png")}}" alt="" title=""></div>
            </div>
        </div>
    </section>
@endsection
