...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    private $repositories = [
        \App\Domain\Reservation\Repositories\Contracts\ReservationRepository::class => \App\Domain\Reservation\Repositories\Eloquent\ReservationRepositoryEloquent::class,
