            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <h5 class=" text-dark font-weight-bold my-1 mr-5 {{ GetLanguage() == 'ar' ? 'ml-2' : '' }}">
                        {{ __('main.edit') }} {{ __('main.reservation') }} </h5>
                    <!--end::Page Title-->
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">
                                {{ __('main.edit') }} {{ __('main.reservations') }} </a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="col-md-12">
                    <div class="card card-custom">
                        <div class="card-header">
                            <h3 class="card-title">
                                {{ __('main.edit') }} {{ __('main.reservation') }}
                            </h3>
                            ...
                            {{-- <form class="form" enctype="multipart/form-data" action="{{ route('users.store') }}" method="POST"> --}}
                                ...
                                <div class="row container-fluid mb-5">
                                    ...
                                    <div class="col-xl-10" id="app">
                                       <reservation-form :all-users="{{ $users }}" :roles="{{ $roles }}" :branches="{{ $branches }}" :edit="{{ $edit }}"   action="edit" auth_token="{{ $auth_token }}"    />
                                    </div>
