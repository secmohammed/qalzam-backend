<div class="flex space-x-1">
    <a href="{{ route('reservations.show', [$id]) }}"
    ...
    <a href="{{ route('reservations.edit', [$id]) }}"
    ...
    <a href="{{ route('reservations.destroy', [$id]) }}"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('main.delete') }} {{ __('main.reservations') }}:
                    #{{ $id }}</h5>
            ...
            <form action="{{ route('reservations.destroy', [$id]) }}" method="post">
                ...
                <div class="modal-body">
                    {{ __('main.delete') }} {{ __('main.reservations') }}: #{{ $id }}
                </div>
