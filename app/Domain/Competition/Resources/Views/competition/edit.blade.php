            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <h5 class=" text-dark font-weight-bold my-1 mr-5 {{ GetLanguage() == 'ar' ? 'ml-2' : '' }}">
                        {{ __('main.edit') }} {{ __('main.competition') }} </h5>
                    <!--end::Page Title-->
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#" class="text-muted">
                                {{ __('main.edit') }} {{ __('main.competitions') }} </a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="col-md-12">
                    <div class="card card-custom">
                        <div class="card-header">
                            <h3 class="card-title">
                                {{ __('main.edit') }} {{ __('main.competition') }}
                            </h3>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" action="{{ route('competitions.update', $edit->id) }}" method="POST"
                                ...
                                <div class="row container-fluid mb-5">
                                    ...
                                    <div class="col-xl-10">
                                        @include("{$alias}::competition._partials._fields", [
                                            'action' => 'edit',
                                            'data' => $edit,
                                        ])
                                    </div>
