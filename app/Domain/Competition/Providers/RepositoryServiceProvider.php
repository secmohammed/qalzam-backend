...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    private $repositories = [
        \App\Domain\Competition\Repositories\Contracts\CompetitionRepository::class => \App\Domain\Competition\Repositories\Eloquent\CompetitionRepositoryEloquent::class,
