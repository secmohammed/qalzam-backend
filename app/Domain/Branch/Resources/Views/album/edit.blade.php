            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            <form class="form" action="{{ route('albums.update', $edit->id) }}" method="POST"
                                ...
                                <div class="row container-fluid mb-5">
                                    ...
                                    <div class="col-xl-10">
                                        @include("{$alias}::album._partials._fields", [
                                            'action' => 'edit',
                                            'branches' => $branches,
                                            'edit' => $edit
                                        ])
