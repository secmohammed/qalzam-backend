    ...
    <div class="container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                {{ __('main.edit') }} {{ __('main.product_variation') }} </h5>
                <!--end::Page Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item">
                        ...
                        {{ __('main.edit') }} {{ __('main.product_variation') }} </a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="col-md-12">
                <div class="card card-custom">
                    <div class="card-header">
                        <h3 class="card-title">
                        {{ __('main.edit') }} {{ __('main.product_variation') }}
                        </h3>
                    ...
                    <div class="card-body">
                        <form class="form" enctype="multipart/form-data" action="{{ route('product_variations.update', $edit->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row container-fluid mb-5">
                                ...
                                <div class="col-lg-2">
                                    <button type="submit"
                                    class="btn btn-block btn-sm btn-light-primary font-weight-bolder text-uppercase py-4">{{__('main.edit')}} {{__('main.product_variation')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
