        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        <form class="form" enctype="multipart/form-data" action="{{ route('stocks.store') }}" method="POST">
                            @csrf
                            <div class="row container-fluid mb-5">
                                ...
                                <div class="col-lg-2">
                                    <button type="submit"
                                    class="btn btn-block btn-sm btn-light-primary font-weight-bolder text-uppercase py-4">{{__('main.create')}} {{__('main.stock')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
