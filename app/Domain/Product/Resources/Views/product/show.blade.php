                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="row mb-2">
                                        ...
                                        @if($show->getLastMedia('product-images'))
                                        <div id="lightgallery">
                                            <div data-src="{{ $show->getLastMediaUrl('product-images') }}">
                                                <a href="{{ $show->getLastMediaUrl('product-images') }}">
                                                    <img class="d-block" src="{{ $show->getLastMediaUrl('product-images') }}"
                                                         style="width:100%" alt="...">
                                                </a>
                                            </div>
                                        </div>
