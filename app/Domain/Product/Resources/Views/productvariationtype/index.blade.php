...
@section('content')
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <h5 class=" text-dark font-weight-bold my-1 mr-5 {{ GetLanguage() == 'ar' ? 'ml-2' : '' }}">
                        {{ __('main.show-all') }} {{ __('main.product_variation_types') }} </h5>
                    <!--end::Page Title-->
    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            <h3 class="card-title">
                {{ __('main.product_variation_types') }}
            </h3>
            <div class="card-toolbar">
                <a href="{{ route('product_variation_types.create') }}"
        ...
        <div class="card-body">
            ...
            <form action="{{route('product_variation_types.delete-all', ['type' => request('type')])}}" method="post">
                @csrf
                @method('DELETE')
