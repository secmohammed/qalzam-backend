            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <h5 class=" text-dark font-weight-bold my-1 mr-5 {{ GetLanguage() == 'ar' ? 'ml-2' : '' }}">
                        {{ __('main.show') }} {{ __('main.ingredient') }} </h5>
                    <!--end::Page Title-->
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('ingredients.index') }}" class="text-muted">
                                {{ __('main.ingredients') }} </a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="col-md-12">
                    <div class="card card-custom">
                        <div class="card-header">
                            <h3 class="card-title">
                                {{ __('main.show') }} {{ __('main.ingredient') }} : # {{ $show->id }}
                            </h3>
                            <div class="card-toolbar">
                                <a title="{{ __('main.create') }} {{ __('main.ingredient') }}"
                                   href="{{ route('ingredients.create') }}"
                                   class="btn btn-light-primary font-weight-bolder mr-2">
                                    <i class="flaticon2-plus"
                                       style="color: #FFF"></i> {{ __("main.add") }} {{ __("main.ingredient") }} </a>
                                <a title="{{ __('main.delete') }} {{ __('main.ingredient') }}"
                                   href="{{ route('ingredients.destroy', $show->id) }}"
                                   class="btn btn-light-danger font-weight-bolder mr-2" data-toggle="modal"
                                   data-target="#delete_{{$show->id}}">
                                    <i class="flaticon2-trash"></i> {{ __("main.delete") }} {{ __("main.ingredient") }} </a>
                                <a title="{{ __('main.edit') }} {{ __('main.ingredient') }}"
                                   href="{{ route('ingredients.edit', $show->id) }}"
                                   class="btn btn-light-warning font-weight-bolder mr-2">
                                    <i class="flaticon2-edit"></i> {{ __("main.edit") }} {{ __("main.ingredient") }} </a>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-5">
                                    <div class="row mb-2">
                                        ...
                                        <span>{{ $show->description ?? 'N/A' }} </span>
                                    </div>
                                    <hr>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row mb-2">
                                        ...
                                        @if($show->getFirstMedia('ingredient-icon'))
                                        <div id="lightgallery">
                                            <div data-src="{{ $show->getFirstMedia('ingredient-icon')->getUrl() }}">
                                                <a href="{{ $show->getFirstMedia('ingredient-icon')->getUrl() }}">
                                                    <img class="d-block" src="{{ $show->getFirstMedia('ingredient-icon')->getUrl() }}"
                                                         style="width:100%" alt="...">
                                                </a>
                                            </div>
                                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ __('main.delete') }} {{ __('main.ingredient') }}
                        : {{ __('main.ingredients') }} #({{ $show->name }})</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    </button>
                </div>
                <form action="{{ route('ingredients.destroy', $show->id) }}" method="post">
                    @csrf
                    @method("DELETE")
                    <div class="modal-body">
                        {{ __('main.delete') }} {{ __('main.ingredients') }}: {{ __('main.ingredients') }} #({{ $show->name }})
                    </div>
