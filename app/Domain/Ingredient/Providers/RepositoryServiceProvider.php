...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    private $repositories = [
        \App\Domain\Ingredient\Repositories\Contracts\IngredientRepository::class => \App\Domain\Ingredient\Repositories\Eloquent\IngredientRepositoryEloquent::class,
