      ...
      <div class=" container ">
          <div class="row justify-content-between  ">
            <div class="col-4 d-flex flex-column "  >
              ...
              <a class="h5 mb-3 "  style="font-weight: bold;"  href=""> http://sjdfs/.com</a>
              <p class="h5 mb-3 font-weight-bold"  style="font-weight: bold;">  {{ __("main.tax-number") }} : 4645798765465 </p>
            </div>
          ...
          <div class="row justify-content-between  ">
            <div class="col-4 d-flex flex-column "  >
              ...
              <p class="h5 font-weight-bold"  style="font-weight: bold;"> {{ __("main.pay-on-delivery") }}</p>
              <p class="h5 mb-3"  style="font-weight: bold;"> {{ __("main.request-date") }} : {{ $order->created_at  }}</p>
              <p class="h5 mb-3"  style="font-weight: bold;"> {{ __("main.invoice-print-date") }} :{{ \Carbon\Carbon::now()->format('Y-m-d h:m:s')  }} </p>
            </div>
              <div class="col-4 d-flex flex-column align-items-end">
 
                <img  alt="Logo"class="mb-3" width="150"  src="{{ asset('assets/images/qalzam-logo.svg') }}" alt="">
        ...
        <table class="table mb-5">
          ...
          <tr>
            <th scope="col" >{{ __("main.to") }}</th>
            <td >{{ $order->user->name }}</td>
            <th scope="col" class="font-weight-bold">{{ __("main.mobile") }}</th>
            <td scope="col">{{ $order->user->mobile }}</td>
          </tr>
          <tr>
