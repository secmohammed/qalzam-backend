...
<div class="col-sm-4 item-basket">
    <div class="inner">
        ...
        <div class="total-price">
            ...
            <p class="textred">جميع الاسعار شاملة ضريبة القيمة المضافة  </p><a class="bottom" id="completionButton" href="{{$finishOrder === 'true' ?'#completion': route('website.finish-order')}}" data-toggle="{{$finishOrder === 'true' ?'modal': ''}}">
