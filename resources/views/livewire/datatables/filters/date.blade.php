<div x-data class="flex flex-col">
    <div class="w-full relative flex">
        <input x-ref="start" class="p-2 m-2 pr-6 text-sm pt-1 flex-grow form-input" type="date"
    ...
    <div class="w-full relative flex">
        <input x-ref="end" class="p-2 m-2 pr-6 text-sm pt-1 flex-grow form-input" type="date"
