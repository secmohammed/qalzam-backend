...
<div class="itemcard" wire:ignore>
    <a class="delet-card" href="#" wire:click="removeProduct({{$product->id}})">
    ...
    <div class="item">
        <div class="photo"><img src="{{$product->image ?: asset('assets/website/images/slider/img-1.jpg')}}" alt=""></div>
    ...
    <div class="spinner">
        <button class="btn btn-default ault" type="button" wire:click="increaseAmount({{$product->id}})">
        ...
        <button class="btn btn-default" type="button" wire:click="reduceAmount({{$product->id}})">
