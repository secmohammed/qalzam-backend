<div class="modal fade" id="code" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content login">
            <div class="headtitle">
                <h3 class="title">تأكيد رقم الجوال</h3>
            ...
            <p class="text">تم إرسال رسالة نصية برمز التحقق للرقم   <span>+9665****204</span> </p>
            <form action="#" method="post">
                ...
                <div class="row">
                    <div class="col-sm-12 field">
                        <input class="form-control text-center" type="text" placeholder="****" value="">
                    </div>
                    <div class="col-sm-12 field">
                        <button class="bottom">تأكيد</button>
                    </div>
                </div>
            </form>
        </div>
