...
return [
    ...
    "expected-time-deliver-service" => "the expected time To deliver the service",
    "value-product-without-tax" => "The value of the products without tax  Additive",
    "tax-additive" => "The value of the products without tax  Additive",
    "tax-additive" => " Tax  additive",
    "subtotal-inclusive-tax " => "The subtotal is inclusive of (T.A)",
